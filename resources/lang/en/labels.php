...
// Error Messages
    ...
    'firebase_service_account_missing_or_invalid' => 'Firebase Admin SDK is not configured. In Admin → Settings → Notification, upload the service account JSON from Firebase Console (Project settings → Service accounts → Generate new private key).',
