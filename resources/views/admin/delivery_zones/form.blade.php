            ...
            <div class="col-12">
                @if(!$googleApiKey)
                    <div class="alert alert-info alert-dismissible" role="alert">
                        ...
                        <div>
                            <h4 class="alert-heading">OpenStreetMap mode</h4>
                            <p class="mb-0 small">
                                No Google Maps API key is configured. This form uses OpenStreetMap tiles, Leaflet, and Photon search (no Google billing).
                                To use Google Maps and Places autocomplete instead, add your API key in
                                <a href="{{ route('admin.settings.show', ['setting' => \App\Enums\SettingTypeEnum::AUTHENTICATION()]) }}"
                                   target="_blank">Authentication settings</a>.
                            </p>
                        </div>
                ...
                <div class="card">
                    ...
                    <form
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <div id="delivery-zone-config" class="d-none"
                                 data-provider="{{ !empty($googleApiKey) ? 'google' : 'osm' }}"></div>
