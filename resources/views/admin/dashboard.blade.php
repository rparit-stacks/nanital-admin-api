        ...
        <div class="row">
            <div class="col-12">
                <div class="card border-warning">
                    <div class="card-body">
                        <h3 class="card-title">Dashboard access required</h3>
                        <p class="text-secondary mb-0">
                            This user does not have <strong>dashboard view</strong> permission. Fix: ensure <code>access_panel</code> is <code>admin</code>,
                            run <code>php artisan db:seed --class=Database\Seeders\DefaultRolesSeeder</code>, then assign the
                            <strong>Super Admin</strong> role to your admin user (e.g. via <code>php artisan tinker</code> and <code>$user-&gt;assignRole(\App\Enums\DefaultSystemRolesEnum::SUPER_ADMIN());</code>).
                        </p>
                    </div>
                </div>
            </div>
