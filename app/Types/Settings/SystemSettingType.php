...
class SystemSettingType implements SettingInterface
{
    ...
    protected static function getValidationRules(): array
    {
        return [
            ...
            // Optional on update: existing files are merged in SettingController (system case)
            'logo' => ['nullable', 'image', 'mimes:png,webp', 'max:5120'],
            ...
            // Symbols can be multi-byte (e.g. ₹, ﷼); must exist in countries when table is seeded
            'currencySymbol' => ['required', 'string', 'max:32', 'exists:countries,currency_symbol'],
        ];
    }
}
